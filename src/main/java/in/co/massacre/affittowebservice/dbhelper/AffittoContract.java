...
public class AffittoContract {
    ...
    public static class CarContract{
        ...
        public static final String FIND_BY_ID_KEY="Car.findById",
                FIND_BY_ID_QUERY="select c from Car c where c._idPK=:id",
                FIND_BY_ID_PARAMETER_ID="id";

        public static final String FIND_BY_ADVERTISEMENT_KEY="Car.findByAdvertisement",
                FIND_BY_ADVERTISEMENT_QUERY="select c from Car c where c.advertisement=:advertisement",
                FIND_BY_ADVERTISEMENT_PARAMTER_ADVERTISEMENT="advertisement";

        public static final String FIND_BY_BRANDNAME_KEY="Car.findByBrandName",
                FIND_BY_BRANDNAME_QUERY="select c from Car c where c.carBrandNameFK=:carBrandName",
                FIND_BY_BRANDNAME_PARAMETER_BRANDNAME="carBrandName";

        public static final String FIND_BY_MODELNAME_KEY="Car.findByModelName",
                FIND_BY_MODELNAME_QUERY="select c from Car c where c.carModelNameFK=:carModelName",
                FIND_BY_MODELNAME_PARAMETER_MODELNAME="carModelName";

        public static final String FIND_BY_COLOR_KEY="Car.findByColor",
                FIND_BY_COLOR_QUERY="select c from Car c where c.colorFK=:color",
                FIND_BY_COLOR_PARAMETER_COLOR="color";

        public static final String FIND_BY_AFTER_YEAR_OF_REG_KEY="Car.findByAfterYearOfRegistration",
                FIND_BY_AFTER_YEAR_OF_REG_QUERY="select c from Car c where c.yearOfRegistration>=:yearOfRegistration",
                FIND_BY_AFTER_YEAR_OF_REG_PARAMETER_YEAR="yearOfRegistration";

        public static final String FIND_BY_KILOMETER_DRIVEN_KEY="Car.findByKilometerDriven",
                FIND_BY_KILOMETER_DRIVEN_QUERY="select c from Car c where c.kilometerDriven<=:kilometerDriven",
                FIND_BY_KILOMETER_DRIVEN_PARAMETER_KM="kilometerDriven";

        public static final String FIND_BY_FUEL_TYPE_KEY="Car.findByCarFuelType",
                FIND_BY_FUEL_TYPE_QUERY="select c from Car c where c.carFuelTypeFK=:carFuelType",
                FIND_BY_FUEL_TYPE_PARAMETER_FUEL_TYPE="carFuelType";

        public static final String FIND_BY_FILTER_KEY="Car.findByFilter",
                FIND_BY_FILTER_QUERY="select c from Car c where c.carBrandNameFK in (:brandNameList) " +
                                        "and c.carModelNameFK in (:modelNameList)",
                FIND_BY_FILTER_PARAMETER_BRANDNAME_LIST="brandNameList",
                FIND_BY_FILTER_PARAMETER_MODELNAME_LIST="modelNameList";
